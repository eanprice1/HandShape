    ...
    for image_path in image_paths:
        ...
        while len(point_collection) < 15:
            ...
            if len(point_collection) == 2:
                metrics.finger1 = FingerMetrics(point_collection[0], point_collection[1])
            if len(point_collection) == 4:
                metrics.finger2 = FingerMetrics(point_collection[2], point_collection[3])
            if len(point_collection) == 6:
                metrics.finger3 = FingerMetrics(point_collection[4], point_collection[5])
            if len(point_collection) == 8:
                metrics.finger4 = FingerMetrics(point_collection[6], point_collection[7])
            if len(point_collection) == 10:
                metrics.measurement1 = Feature(point_collection[8], point_collection[9])
            if len(point_collection) == 12:
                metrics.measurement2 = Feature(point_collection[10], point_collection[11])
            if len(point_collection) == 14:
                metrics.measurement3 = Feature(point_collection[12], point_collection[13])
            metrics.draw_lines()
